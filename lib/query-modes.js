...
const METHOD_TERMS =
  /\b(VIKOR|TOPSIS|AHP|ANP|ELECTRE|PROMETHEE|MACBETH|MCDM|multi[\s-]?criteria|SAW|WASPAS|EDAS|CODAS|TOE|TAM|UTAUT)\b/i;
...
3. If the question names a method or framework (VIKOR, TOPSIS, TOE, TAM, …), prioritize criteria or constructs for that exact named model. If the corpus does not explicitly mention it, say evidence is insufficient — do not map other frameworks (e.g. LEED/BREEAM) onto it unless the text explicitly links them.
